		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zcursoapp1es-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcursoapp1es-display": {
								"semanticObject": "zcursoapp1es",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcursoapp1es",
									"url": sap.ui.require.toUrl("zcursoapp1es")
								}
							}
						}
					}

		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#zcursoapp1esantana-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcursoapp1esantana-display": {
								"semanticObject": "zcursoapp1esantana",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcursoapp1esantana",
									"url": sap.ui.require.toUrl("zcursoapp1esantana")
								}
							}
						}
					}
